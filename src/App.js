...
import { onSnapshot, query, collection, updateDoc, doc, addDoc, deleteDoc } from "firebase/firestore";
  ...
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        {todos.length < 1 ? null : <p className={style.count}>{`U have ${todos.length} todos !!!`}</p>}
      </div>
    </div>
  );
}
